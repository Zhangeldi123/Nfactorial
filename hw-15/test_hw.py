...
class TestExercise(unittest.TestCase):
    ...
    def test_rectangle1(self):
        rectangle = hw.Rectangle1(3, 4)
        self.assertEqual(rectangle.area(), 12)
        self.assertEqual(rectangle.perimeter(), 14)
        self.assertFalse(rectangle.is_square(), False)
        square = hw.Rectangle1(4, 4)
    ...
    def test_triangle(self):
        triangle = hw.Triangle2(3, 4, 5)
        self.assertEqual(triangle.area(), 6)
        self.assertEqual(triangle.perimeter(), 12)
        with self.assertRaises(ValueError):
            triangle = hw.Triangle2(-1, 4, 5)
        with self.assertRaises(ValueError):
            triangle = hw.Triangle2(10, 4, 5)
