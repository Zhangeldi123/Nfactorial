...
def recursive_sum(my_list: list) -> int:
    if len(my_list) == 0:
        return 0  
    total = my_list.pop()  
    return total + recursive_sum(my_list)  
"""
